...
public class IncidenteController extends Controller implements ICrudViewsHandler {
    ...
    public void save(Context context) {
        ...
        usuario.generarIncidente(
                ...
                this.obtenerPrestacion(context, entityManager),
    ...
    private PrestacionDeServicio obtenerPrestacion(Context context, EntityManager entityManager) {
        ...
        prestacionDeServicio.setServicio(this.repositorioServicios.obtenerServicio(
                Long.parseLong(Objects.requireNonNull(context.formParam("servicio"))), entityManager));
        prestacionDeServicio.setEstablecimiento(this.repositorioEstablecimientos.obtenerEstablecimiento(
                Long.parseLong(Objects.requireNonNull(context.formParam("establecimiento"))), entityManager));
        prestacionDeServicio.setEntidad(this.repositorioEntidades.obtenerEntidad(
                Long.parseLong(Objects.requireNonNull(context.formParam("entidad"))), entityManager));
