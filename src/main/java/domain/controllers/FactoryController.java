...
public class FactoryController {
    ...
    public static Object controller(String nombre){
        ...
        return switch (nombre) {
            case "incidentes" -> new IncidenteController(new RepositorioIncidentes(), new RepositorioServicios(), new RepositorioEstablecimientos(), new RepositorioEntidades(), new RepositorioComunidades(), new RepositorioUsuarios(), new RepositorioPrestaciones());
